...
import convert from "color-convert"; // Importing the color-convert library
import LabeledInput from "../common/labeled-input"; // Importing the LabeledInput component
import { type ColorActions } from "../../reducer/color-reducer";
...
const HexToRGB = ({ hexColor, dispatch }: HexToRGBProps) => {
  ...
  const color = convert.hex.rgb(hexColor);
  const [r, g, b] = color;
